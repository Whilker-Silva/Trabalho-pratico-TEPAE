...
public abstract class ItemDinamico extends Item {
    ...
    // Atribui uma localizacao para os atributos localizacaoAtual e para
    // localizacaoDestino
     ...
     * 
     * @param localizacaoDestino Localizacao que vai ser atribuida a
     *                           localizacaoDestino
     */
    ...
    /**
     * Metodo que primeiramente checa se a a Localizacao destino existe, caso a
     * resposta seja true,
     ...
     *                    para checar se o ItemDinamico chegou ao seu destino
    ...
    /**
     * Metodo que troca a Localizacao destino que varia entre a Localizacao do
     * ponto1 e do ponto2, vendo antes se o
     * ItemDinamico está em alguma dessas lcalizações, caso esteja, ele atribui o
     * destino ao outro ponto, caso contrario,
     * se mantem a mesma localizacaoDestino
     * 
     * @param localizacaoPonto1 Localizacao que vai ser comparada ou atribuida a
     *                          localizacaoDestino dependendo do caso
     * @param localizacaoPonto2 Localizacao que vai ser comparada ou atribuida a
     *                          localizacaoDestino dependendo do caso
     */
